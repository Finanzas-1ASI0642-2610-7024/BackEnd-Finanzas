...
exports.createVehicle = async (req, res) => {
    try {
        const { marca, modelo, anio, precio, imagen } = req.body;
        const newVehicle = await Vehiculo.create({ marca, modelo, anio, precio, imagen });
...
exports.updateVehicle = async (req, res) => {
    try {
        ...
        await vehicle.update({ marca, modelo, anio, precio, imagen });
